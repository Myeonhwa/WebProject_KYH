...
<table border="1" width="90%">
    ...
    <tr>
        ...
        <td>
        	...
        	<a href="../databoard/downloadData?ofile=${ dto.ofile }&sfile=${ dto.sfile }&idx=${ dto.idx }">
        	[다운로드]
        	</a>
        	</c:if>              
        </td>
    ...
    <tr>
        <td colspan="4" align="center">
            <button type="button" onclick="location.href='../databoard/edit.do?idx=${ param.idx }';">
                수정하기
            </button>
            <button type="button" onclick="location.href='../databoard/deleteData.do?idx=${ param.idx }';">
                삭제하기
            </button>
            <button type="button" onclick="location.href='../databoard/dataListPage.do';">
                목록 바로가기
            </button>
        </td>
    </tr>
